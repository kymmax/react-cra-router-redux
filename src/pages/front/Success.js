      ...
      <div className='mt-5 mb-7'>
        <div className='row'>
          <div className='col-md-6'>
            ...
            <Link to='/' className='btn btn-outline-dark bg-primary me-2 rounded-0 mb-4'>
              回到首頁
            </Link>
          </div>
          <div className='col-md-6'>
            <div className='card bg-dark rounded-0 py-4'>
              <div className='card-header border-bottom-0 px-4 py-0'>
                <h2>選購餐點細節</h2>
              </div>
